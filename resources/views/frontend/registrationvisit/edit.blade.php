    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.doctorvisits.update", [$doctorvisit->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="complaint" id="complaint">{!! old('complaint', $doctorvisit->complaint) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="objectivestat" id="objectivestat">{!! old('objectivestat', $doctorvisit->objectivestat) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="treatment" id="treatment">{!! old('treatment', $doctorvisit->treatment) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="mkb_id" id="mkb_id">
                                @foreach($mkbs as $mkb)
                                    <option value="{{ $mkb->id }}" {{ (old('mkb_id') ? old('mkb_id') : $doctorvisit->mkb->id ?? '') == $mkb->id ? 'selected' : '' }}>{{ $mkb->code }} {{ $mkb->name }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('mkb'))
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="datetimepriem" id="datetimepriem" value="{{ old('datetimepriem', $doctorvisit->datetimepriem) }}">
