    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.shedules.update", [$shedule->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="name">{{ trans('cruds.shedule.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $shedule->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="worktimestart" id="worktimestart" value="{{ old('worktimestart', $shedule->worktimestart) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="worktimeend" id="worktimeend" value="{{ old('worktimeend', $shedule->worktimeend) }}" required>
