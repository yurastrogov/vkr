    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.contragents.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="fathername" id="fathername" value="{{ old('fathername', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="berthday" id="berthday" value="{{ old('berthday') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="snils" id="snils" value="{{ old('snils', '') }}">
                            @if($errors->has('snils'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('snils') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="polis" id="polis" value="{{ old('polis', '') }}" required>
                            @if($errors->has('polis'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('polis') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="spasport" id="spasport" value="{{ old('spasport', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="npasport" id="npasport" value="{{ old('npasport', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="pasportvudan" id="pasportvudan" value="{{ old('pasportvudan', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="datepasport" id="datepasport" value="{{ old('datepasport') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="codepasport" id="codepasport" value="{{ old('codepasport', '') }}">
