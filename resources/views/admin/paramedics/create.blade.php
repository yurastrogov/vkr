...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.paramedic.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.paramedics.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fathername') ? 'is-invalid' : '' }}" type="text" name="fathername" id="fathername" value="{{ old('fathername', '') }}" required>
