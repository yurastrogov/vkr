...
@can('contragent_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            ...
            @include('csvImport.modal', ['model' => 'Contragent', 'route' => 'admin.contragents.parseCsvImport'])
        </div>
    </div>
@endcan
<div class="card">
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="search" strict="true">
                                ...
                                @foreach(App\Models\Contragent::GENDER_RADIO as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-Contragent:not(.ajaxTable)').DataTable({ buttons: dtButtons })
