...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.contragent.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.contragents.update", [$contragent->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="surname">{{ trans('cruds.contragent.fields.surname') }}</label>
                <input class="form-control {{ $errors->has('surname') ? 'is-invalid' : '' }}" type="text" name="surname" id="surname" value="{{ old('surname', $contragent->surname) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $contragent->name) }}" required>
                @if($errors->has('name'))
                    <div class="invalid-feedback">
                        {{ $errors->first('name') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fathername') ? 'is-invalid' : '' }}" type="text" name="fathername" id="fathername" value="{{ old('fathername', $contragent->fathername) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('berthday') ? 'is-invalid' : '' }}" type="text" name="berthday" id="berthday" value="{{ old('berthday', $contragent->berthday) }}" required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Contragent::GENDER_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('gender') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="gender_{{ $key }}" name="gender" value="{{ $key }}" {{ old('gender', $contragent->gender) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" type="text" name="address" id="address" value="{{ old('address', $contragent->address) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telephone') ? 'is-invalid' : '' }}" type="text" name="telephone" id="telephone" value="{{ old('telephone', $contragent->telephone) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('snils') ? 'is-invalid' : '' }}" type="text" name="snils" id="snils" value="{{ old('snils', $contragent->snils) }}">
                @if($errors->has('snils'))
                    <div class="invalid-feedback">
                        {{ $errors->first('snils') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('polis') ? 'is-invalid' : '' }}" type="text" name="polis" id="polis" value="{{ old('polis', $contragent->polis) }}" required>
                @if($errors->has('polis'))
                    <div class="invalid-feedback">
                        {{ $errors->first('polis') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spasport') ? 'is-invalid' : '' }}" type="text" name="spasport" id="spasport" value="{{ old('spasport', $contragent->spasport) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('npasport') ? 'is-invalid' : '' }}" type="text" name="npasport" id="npasport" value="{{ old('npasport', $contragent->npasport) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pasportvudan') ? 'is-invalid' : '' }}" type="text" name="pasportvudan" id="pasportvudan" value="{{ old('pasportvudan', $contragent->pasportvudan) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('datepasport') ? 'is-invalid' : '' }}" type="text" name="datepasport" id="datepasport" value="{{ old('datepasport', $contragent->datepasport) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('codepasport') ? 'is-invalid' : '' }}" type="text" name="codepasport" id="codepasport" value="{{ old('codepasport', $contragent->codepasport) }}">
