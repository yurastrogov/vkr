...
class MkbController extends Controller
{
    ...
    public function index()
    {
        ...
        $mkbs = Mkb::paginate(25);

        return view('frontend.mkbs.index', compact('mkbs'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.mkbs.create');
    }
    ...
    public function store(StoreMkbRequest $request)
    {
        ...
        return redirect()->route('frontend.mkbs.index');
    }
    ...
    public function edit(Mkb $mkb)
    {
        ...
        return view('frontend.mkbs.edit', compact('mkb'));
    }
    ...
    public function show(Mkb $mkb)
    {
        ...
        return view('frontend.mkbs.show', compact('mkb'));
    }
