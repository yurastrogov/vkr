...
class LpuController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.lpus.index', compact('lpus'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.lpus.create');
    }
    ...
    public function store(StoreLpuRequest $request)
    {
        ...
        return redirect()->route('frontend.lpus.index');
    }
    ...
    public function edit(Lpu $lpu)
    {
        ...
        return view('frontend.lpus.edit', compact('lpu'));
    }
    ...
    public function show(Lpu $lpu)
    {
        ...
        return view('frontend.lpus.show', compact('lpu'));
    }
