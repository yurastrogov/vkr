...
class WorkdayController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.workdays.index', compact('workdays'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.workdays.create');
    }
    ...
    public function store(StoreWorkdayRequest $request)
    {
        ...
        return redirect()->route('frontend.workdays.index');
    }
    ...
    public function edit(Workday $workday)
    {
        ...
        return view('frontend.workdays.edit', compact('workday'));
    }
    ...
    public function show(Workday $workday)
    {
        ...
        return view('frontend.workdays.show', compact('workday'));
    }
