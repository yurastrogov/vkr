...
class ContragentController extends Controller
{
    ...
    public function index()
    {
        ...
        $contragents = Contragent::with(['insurance', 'insertion'])->paginate(25);

        $insurances = Insurance::get();

        $lpus = Lpu::get();

        return view('frontend.contragents.index', compact('contragents', 'insurances', 'lpus'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.contragents.create', compact('insertions', 'insurances'));
    }
    ...
    public function store(StoreContragentRequest $request)
    {
        ...
        return redirect()->route('frontend.contragents.index');
    }
    ...
    public function edit(Contragent $contragent)
    {
        ...
        return view('frontend.contragents.edit', compact('contragent', 'insertions', 'insurances'));
    }
    ...
    public function show(Contragent $contragent)
    {
        ...
        return view('frontend.contragents.show', compact('contragent'));
    }
