...
class ParamedicController extends Controller
{
    ...
    public function index()
    {
        ...
        $paramedics = Paramedic::with(['id_user', 'speciality', 'shedule'])->paginate(10);
        ...
        return view('frontend.paramedics.index', compact('medicpositions', 'paramedics', 'shedules', 'users'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.paramedics.create', compact('id_users', 'shedules', 'specialities'));
    }
    ...
    public function edit(Paramedic $paramedic)
    {
        ...
        return view('frontend.paramedics.edit', compact('id_users', 'paramedic', 'shedules', 'specialities'));
    }
