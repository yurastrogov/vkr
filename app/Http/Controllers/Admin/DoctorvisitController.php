...
class DoctorvisitController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.doctorvisits.index', compact('doctorvisits'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.doctorvisits.create', compact('idcontractors', 'mkbs'));
    }
    ...
    public function store(StoreDoctorvisitRequest $request)
    {
        ...
        return redirect()->route('admin.doctorvisits.index');
    }
    ...
    public function edit(Doctorvisit $doctorvisit)
    {
        ...
        return view('admin.doctorvisits.edit', compact('doctorvisit', 'idcontractors', 'mkbs'));
    }
    ...
    public function show(Doctorvisit $doctorvisit)
    {
        ...
        return view('admin.doctorvisits.show', compact('doctorvisit'));
    }
